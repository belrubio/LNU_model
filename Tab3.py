...
class Tab3(tk.Frame):
    ...
    def runSimulation(self):
        ...
        done = SimulationsMain(self, float(self.entry1.get()), float(self.entry2.get()), float(self.entry3.get()), float(self.entry4.get()), float(self.entry5.get()), int(self.entry6.get()), int(self.entry7.get()), int(self.entry8.get()), False, False)
